...
//
// FaStackComponent is not supported yet
//
// @Component({
//   selector: 'fa-stack',
//   template: '<i [ngClass]="classList"></i>'
...
//           if (previousValue == 1) this.removeFaClass('fa-lg')
//           else this.removeFaClass(`fa-${previousValue}x`)
//           if (currentValue == 1) this.classList.push('fa-lg')
//           else this.classList.push(`fa-${currentValue}x`)
//         }
//       }
//     }
// }
